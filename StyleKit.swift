...
//  Double Pendulum
//
//  Created by Andrei Frolov on 2018-02-21.
...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawDoublePendulum(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 640, height: 640), resizing: ResizingBehavior = .aspectFit, phi: CGFloat = 0, psi: CGFloat = 0, upsilon: CGFloat = 0, spread: CGFloat = 20, g: CGFloat = 0.5) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
